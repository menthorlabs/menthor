...
<template>
  <button
    type="button"
    class="flex cursor-pointer items-center gap-2 rounded-lg border-none px-5 py-2.5 text-sm font-medium focus:ring-4"
    :class="[colors[color as keyof typeof colors]]"
  >
